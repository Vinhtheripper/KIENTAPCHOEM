...
export const navLinks = [
  ...
  { to: '/app/content', label: 'Content', icon: FileText, roles: ['pet_owner'] },
  { to: '/app/content', label: 'All Content', icon: FileText, roles: ['admin'] },
  { to: '/app/timeline', label: 'Timeline', icon: CalendarDays, roles: ['pet_owner', 'admin'] },
  { to: '/app/chat', label: 'AI Chat', icon: Bot, roles: ['pet_owner'] },
